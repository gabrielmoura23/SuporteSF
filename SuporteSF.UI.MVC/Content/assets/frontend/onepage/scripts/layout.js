var Layout = function () {
    ...
    function scrolear(destino) {
        ...
        stop = stop - 58; //$('.header').outerHeight()

        $('html, body').animate({ scrollTop: stop + 'px' }, delay, ant);
        setInterval(function () { if (ane) { $('.header-navigation li').removeClass('current'); ane = false; } }, 1500);
    ...
    return {
        init: function () {
            ...
            $("#login").click(function () {
                event.preventDefault(); // cancel's the '#' click event
                scrolear('#acesso');
            });

            $("#aqui-esqueceu").click(function () {
                event.preventDefault(); // cancel's the '#' click event
                $('#entrar').hide();
                $('#esqueceu').show();
                scrolear('#acesso');
